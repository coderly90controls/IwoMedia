...
public class WheelView extends View {
	...
	private static final int VALUE_TEXT_COLOR = 0xFF3f3f51;// 被选中字体的颜色值。
	/** Items text color */
	private static final int ITEMS_TEXT_COLOR = 0xf0A7A7A7;

	/** Top and bottom shadows colors */
	private static final int[] SHADOWS_COLORS = new int[] { 0xffffff, 0xffffff, 0xffffff };

	/** Additional items height (is added to standard text item height) */
	private  int ADDITIONAL_ITEM_HEIGHT = 27;
	/** Text size */
    ...
    private static  boolean densityOr=true;
	// Listeners
	...
	private void initResourcesIfNecessary() {
		...
		if (valuePaint == null) {
			...
			valuePaint.setTextSize(TEXT_SIZE + 2); // 在这里设置选中字体的大小
			valuePaint.setShadowLayer(0.1f, 0, 0.1f, 0xFFC0C0C0);
		}

		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(R.drawable.zhezhao);
		}
		if (topShadow == null) {
	...
	/**
	 *  调用此方法根据密度设置字体的大小，和Item的值。
	 */
	public  void setScreenAdapter(){
		//if(densityOr){
			ADDITIONAL_ITEM_HEIGHT=(int) (ADDITIONAL_ITEM_HEIGHT*density);
